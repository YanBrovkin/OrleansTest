...
namespace ServerApp.Grains
{
    ...
    public class UserGrain : Grain<UserGrainState>, IUserGrain
    {
        ...
        public override async Task OnActivateAsync()
        {
            ...
            var testStream = kafkaProvider.GetStream<SimpleResultSpecification>(Guid.Empty, "testTopic"); // todo: use stream utils
        ...
        private Task OnNextTestMessage(SimpleResultSpecification message, StreamSequenceToken sequenceToken)
        {
